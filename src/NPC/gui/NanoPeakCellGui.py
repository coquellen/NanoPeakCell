...
class RightPanel(wx.Panel):
    ...
    def __init__(self, parent, log):
        ...
        with open(os.path.join(NPCVar(), 'src','NPC', 'cmap.lst')) as f:
    ...
    def CreateMainPanel(self):
        ...
        img = wx.Bitmap(os.path.join(self.root, 'src','NPC',"bitmaps", "player_play.png"))
        self.playPauseBtn = buttons.GenBitmapToggleButton(self, bitmap=img, name="play")
        self.playPauseBtn.Enable(True)

        img = wx.Bitmap(os.path.join(self.root, 'src','NPC',"bitmaps", "player_pause.png"))
...
class Logo(wx.SplashScreen):
    def __init__(self, parent=None):
        self.root = NPCVar()
        Logo = wx.Image(name=os.path.join(self.root, "src",'NPC','bitmaps', 'NPC.png')).ConvertToBitmap()
